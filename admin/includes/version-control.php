               ...
               <div class="pb-row">
                  <table class="pb-beta-table">
                     ...
                     <tr class="pb-roll-row">
                        ...
                        <td>
                           <div><?php echo sprintf( '<a href="%s" target="_blank" class="button pb-btn pb-rollback-button elementor-button-spinner">Reinstall Version 1.3.8</a>', wp_nonce_url( admin_url( 'admin-post.php?action=premium_gutenberg_rollback' ), 'premium_gutenberg_rollback' ) ); ?> </div>
