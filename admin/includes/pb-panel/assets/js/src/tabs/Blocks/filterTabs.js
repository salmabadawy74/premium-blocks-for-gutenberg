...
const FilterTabs = () => {
    ...
    const blocksStatuses = useSelector((state) => state.blocksStatuses.blocks);
    const activeBlocksFilterTab = useSelector((state) => state.blocksStatuses.activeBlocksFilterTab);
