...
const SingleOption = props => {
  ...
  const handleChange = () => {
    let newValue = !value;
    setValue(newValue);
    props.onChange(newValue, props.optionId); // const body = new FormData();
...
const RendeTabs = () => {
  const [activeTab, setTab] = (0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(PremiumBlocksPanelData.kemet_redirect);
  let {
    tabs
