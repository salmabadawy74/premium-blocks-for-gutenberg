...
const OptionsTab = props => {
  ...
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useDispatch)(); // const { createNotice } = useDispatch(noticesStore);

  const handleChange = async (newValues, id) => {
    let newItems = { ...blocks
    };
    newItems[id] = newValues;
    dispatch(_features_blocks_index__WEBPACK_IMPORTED_MODULE_4__.updateblockStatus.updateblockStatus(newItems));
