...
if ( ! class_exists( 'Premium_Guten_Blocks' ) ) {
	...
	class PBG_Admin {
		...
		public static $pbg_blocks = array( 'dualHeading', 'banner', 'pricingTable', 'maps', 'testimonial', 'countUp', 'icon', 'button', 'container', 'accordion', 'iconBox', 'videoBox', 'fancyText', 'lottie', 'image-separator', 'modal', 'bulletList' );
						...
						<table class="pb-elements-table">
							<tbody>
								...
								<th><?php echo __( 'Premium Image Separator', 'premium-gutenberg' ); ?></th>
									...
									<td>
										<label class="switch">
											<input type="checkbox" id="modal" name="modal" <?php checked( 1, $this->pbg_get_settings['modal'], true ); ?>>
											<span class="slider round"></span>
										</label>
									</td>
								</tr>
