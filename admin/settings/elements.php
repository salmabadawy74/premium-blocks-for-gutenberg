...
if ( ! class_exists('Premium_Guten_Blocks') ) {
    ...
    */
    class Premium_Guten_Admin {
        ...
        public static $pbg_blocks = ['dualHeading','banner','pricingTable','maps','testimonial', 'countUp', 'icon', 'button', 'container', 'accordion', 'iconBox', 'videoBox', 'person' , 'countDown'];
                        ...
                        <table class="pb-elements-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo __('Premium Count Down', 'premium-gutenberg'); ?></th>
                                    <td>
                                        <label class="switch">
