...
if ( ! class_exists('Premium_Guten_Blocks') ) {
    ...
    */
    class PBG_Admin {
        ...
        public static $pbg_blocks = ['dualHeading','banner','pricingTable','maps','testimonial', 'countUp', 'icon', 'button', 'container', 'accordion', 'iconBox', 'videoBox', 'fancyText','lottie'];
                    ...
                    <div id="pb-modules" class="pb-settings-tab">
                        ...
                        <table class="pb-elements-table">
                            <tbody>
                                ...
                                <th><?php echo __('Premium Lottie', 'premium-gutenberg'); ?></th>
                                    <td>
                                        <label class="switch">
