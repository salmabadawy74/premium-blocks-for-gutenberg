...
if ( ! class_exists( 'Premium_Guten_Blocks' ) ) {
	...
	class PBG_Admin {
		...
		public static $pbg_blocks = array( 'dualHeading', 'banner', 'pricingTable', 'maps', 'testimonial', 'countUp', 'icon', 'button', 'container', 'accordion', 'iconBox', 'videoBox', 'fancyText', 'lottie', 'person' );
