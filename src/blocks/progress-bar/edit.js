                ...
                <InspectorControls>
                    ...
                    {label && (
                        ...
                        >
                            ...
                            <PremiumTypo
                                ...
                                fontSize={labelStyles[0].LabelfontSize}
                                fontSizeMobile={labelStyles[0].LabelfontSizeMobile}
                                fontSizeTablet={labelStyles[0].LabelfontSizeTablet}
                                onChangeSize={newSize => saveLabelStyles({ LabelfontSize: newSize })}
                                onChangeTabletSize={newSize => saveLabelStyles({ LabelfontSizeTablet: newSize })}
                                onChangeMobileSize={newSize => saveLabelStyles({ LabelfontSizeMobile: newSize })}
                    ...
                    >
                        ...
                        <PremiumTypo
                            ...
                            fontSize={percentageStyles[0].percentagefontSize}
                            fontSizeMobile={percentageStyles[0].percentagefontSizeMobile}
                            fontSizeTablet={percentageStyles[0].percentagefontSizeTablet}
                            onChangeSize={newSize => saveParcentageStyles({ percentagefontSize: newSize })}
                            onChangeTabletSize={newSize => saveParcentageStyles({ percentagefontSizeTablet: newSize })}
                            onChangeMobileSize={newSize => saveParcentageStyles({ percentagefontSizeMobile: newSize })}
