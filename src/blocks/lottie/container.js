    ...
    return (
        <Fragment>
            <Placeholder
                ...
                instructions={__(
                    "Add Lottie animations and files to your website.",
                    "premium-blocks-for-gutenberg"
                )}
                className={className}
            >
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        {__(
                            "You can enable JSON uploads from Settings.",
                            "premium-blocks-for-gutenberg"
                        )}
                    </ExternalLink>
                    <br />
                    <br />
                    {__(
                        "You will have to refresh the page after changing JSON upload settings.",
                        "premium-blocks-for-gutenberg"
                    )}
                </Modal>
            )}
