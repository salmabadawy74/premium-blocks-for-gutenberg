...
const { InspectorControls, RichText, useBlockProps, BlockControls } =
    wp.blockEditor;
const { __ } = wp.i18n;
                    ...
                    <InspectorTab key={"layout"}>
                        ...
                        >
                            ...
                            <SelectControl
                                ...
                                onChange={(newValue) =>
                                    setAttributes({ ratioValue: newValue })
                                }
                            />
                        </PanelBody>
                    </InspectorTab>
                        ...
                        {overlay && (
                            ...
                            >
                                ...
                                <PremiumFilters
                                    value={overlayFilter}
                                    onChange={(value) =>
                                        setAttributes({ overlayFilter: value })
                                    }
                                />
                            </PanelBody>
                        )}
