                 ...
                 <InspectorControls key={"inspector"}>
                     ...
                     >
                         ...
                         <PremiumTypo
                             ...
                             onChangeSizeTablet={newSize =>
                                setAttributes( { firstSizeTablet: newSize || 20 } )
                            }
                            onChangeSizeMobile={newSize =>
                                setAttributes( { firstSizeMobile: newSize || 20 } )
                            }
                     ...
                     >
                         ...
                         <PremiumTypo
                             ...
                             onChangeSizeTablet={newSize =>
                                setAttributes( { secondSizeTablet: newSize || 20 } )
                            }
                            onChangeSizeMobile={newSize =>
                                setAttributes( { secondSizeMobile: newSize || 20 } )
                            }
                             onChangeWeight={newWeight =>
