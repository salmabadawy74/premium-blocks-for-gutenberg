                    ...
                    >
                        ...
                        <PremiumResponsiveMargin
                            ...
                            onChangeMarginRight={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstMarginR: newValue })
                            ...
                            onChangeMarginLeft={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstMarginL: newValue })
                                    } else if (device === "tablet") {
                        ...
                        <PremiumResponsivePadding
                            ...
                            onChangePaddingTop={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstPaddingT: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingRight={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstPaddingR: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingBottom={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstPaddingB: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingLeft={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ firstPaddingL: newValue })
                                    } else if (device === "tablet") {
                    ...
                    >
                        ...
                        <PremiumResponsiveMargin
                            ...
                            onChangeMarginRight={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondMarginR: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangeMarginLeft={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondMarginL: newValue })
                                    } else if (device === "tablet") {
                        ...
                        <PremiumResponsivePadding
                            ...
                            onChangePaddingTop={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondPaddingT: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingRight={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondPaddingR: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingBottom={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondPaddingB: newValue })
                                    } else if (device === "tablet") {
                            ...
                            onChangePaddingLeft={
                                (device, newValue) => {
                                    if (device === "desktop") {
                                        setAttributes({ secondPaddingL: newValue })
                                    } else if (device === "tablet") {
