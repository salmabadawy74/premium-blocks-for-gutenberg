...
function PremiumAccordion(props) {
    ...
    const loadStyles = () => {
        ...
        styles[`.${blockId} .premium-accordion__title_wrap`] = {
            ...
            'border-top-width': `${titleBorder?.borderWidth[props.deviceType]?.top}px`,
            'border-right-width': `${titleBorder?.borderWidth[props.deviceType]?.right}px`,
            'border-bottom-width': `${titleBorder?.borderWidth[props.deviceType]?.bottom}px`,
            'border-left-width': `${titleBorder?.borderWidth[props.deviceType]?.left}px`,
            'border-color': titleBorder?.borderColor,
            'border-top-left-radius': `${titleBorder?.borderRadius[props.deviceType].top || 0}px`,
        ...
        styles[`.${blockId} .premium-accordion__desc_wrap`] = {
            ...
            'border-top-width': `${descBorder?.borderWidth[props.deviceType].top}px`,
            'border-right-width': `${descBorder?.borderWidth[props.deviceType].right}px`,
            'border-bottom-width': `${descBorder?.borderWidth[props.deviceType].bottom}px`,
            'border-left-width': `${descBorder?.borderWidth[props.deviceType].left}px`,
            'border-color': descBorder?.borderColor,
            'border-top-left-radius': `${descBorder?.borderRadius[props.deviceType].top || 0}px`,
            'border-top-right-radius': `${descBorder?.borderRadius[props.deviceType].right || 0}px`,
            'border-bottom-left-radius': `${descBorder?.borderRadius[props.deviceType].bottom || 0}px`,
            'border-bottom-right-radius': `${descBorder?.borderRadius[props.deviceType].left || 0}px`,
        ...
        styles[`.${blockId} .premium-accordion__desc_wrap .premium-accordion__desc`] = {
            ...
            'letter-spacing': `${descTypography?.letterSpacing[props.deviceType]}${descTypography?.letterSpacing.unit}`,
