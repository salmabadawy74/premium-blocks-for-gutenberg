...
if (accordions.length) {
    ...
    accordions.forEach(accordion => {
        const accordionItems = accordion.querySelectorAll('.premium-accordion__content_wrap');
        const firstItem = accordionItems[0];
        const firstItemDescription = firstItem.querySelector('.premium-accordion__desc_wrap');
        const firstItemIcon = firstItem.querySelector('.premium-accordion__desc_wrap');
        ...
        if (accordionItems.length) {
            accordionItems.forEach((item, index) => {
                const itemTitle = item.querySelector('.premium-accordion__title_wrap');
                const itemDescription = item.querySelector('.premium-accordion__desc_wrap');
                const itemIcon = item.querySelector('.premium-accordion__icon');
