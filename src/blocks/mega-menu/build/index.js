...
/* harmony import */ var _use_navigation_menu__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../use-navigation-menu */ "./mega-menu/use-navigation-menu.js");
/* harmony import */ var _use_navigation_entities__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../use-navigation-entities */ "./mega-menu/use-navigation-entities.js");
/* harmony import */ var _placeholder__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./placeholder */ "./mega-menu/edit/placeholder/index.js");
/* harmony import */ var _inner_blocks__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./inner-blocks */ "./mega-menu/edit/inner-blocks.js");
/* harmony import */ var _navigation_menu_name_control__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./navigation-menu-name-control */ "./mega-menu/edit/navigation-menu-name-control.js");
/* harmony import */ var _unsaved_inner_blocks__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./unsaved-inner-blocks */ "./mega-menu/edit/unsaved-inner-blocks.js");
/* harmony import */ var _navigation_menu_delete_control__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./navigation-menu-delete-control */ "./mega-menu/edit/navigation-menu-delete-control.js");
/* harmony import */ var _use_navigation_notice__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./use-navigation-notice */ "./mega-menu/edit/use-navigation-notice.js");
/* harmony import */ var _use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./use-create-navigation-menu */ "./mega-menu/edit/use-create-navigation-menu.js");
...
function Navigation(_ref) {
  ...
  } = (0,_use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__["default"])(clientId);
  const isCreatingNavigationMenu = createNavigationMenuStatus === _use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__.CREATE_NAVIGATION_MENU_PENDING;
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    hideNavigationMenuCreateNotice();

    if (createNavigationMenuStatus === _use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__.CREATE_NAVIGATION_MENU_PENDING) {
    ...
    if (createNavigationMenuStatus === _use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__.CREATE_NAVIGATION_MENU_SUCCESS) {
    ...
    if (createNavigationMenuStatus === _use_create_navigation_menu__WEBPACK_IMPORTED_MODULE_21__.CREATE_NAVIGATION_MENU_ERROR) {
  ...
  const [detectedColor, setDetectedColor] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(); // Spacer block needs orientation from context. This is a patch until
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.EntityProvider, {
    ...
    dangerouslySetInnerHTML: {
      __html: [`#${blockProps.id} a{`, `color: ${menuColors === null || menuColors === void 0 ? void 0 : menuColors.link};`, `#${blockProps.id} a:hover {`, `color: ${menuColors.linkHover};`, "}"].join("\n")
    }
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"kemet/mega-menu","title":"Kemet Navigation","category":"premium-blocks","description":"A collection of blocks that allow visitors to get around your site.","keywords":["menu","navigation","links"],"textdomain":"default","attributes":{"ref":{"type":"number"},"menuColors":{"type":"object","default":{"link":"","linkHover":"","background":""}},"submenuColors":{"type":"object","default":{"link":"","linkHover":"","background":""}},"spacing":{"type":"object","default":{"padding":null,"margin":null}},"typography":{"type":"object","default":{"size":null,"weight":400,"family":"Default","letterSpacing":"","textTransform":"","textDecoration":"","lineHeight":"","style":""}},"textColor":{"type":"string"},"customTextColor":{"type":"string"},"rgbTextColor":{"type":"string"},"backgroundColor":{"type":"string"},"customBackgroundColor":{"type":"string"},"rgbBackgroundColor":{"type":"string"},"showSubmenuIcon":{"type":"boolean","default":true},"openSubmenusOnClick":{"type":"boolean","default":false},"__unstableLocation":{"type":"string"},"customOverlayBackgroundColor":{"type":"string"}},"usesContext":["navigationArea"],"providesContext":{"textColor":"textColor","customTextColor":"customTextColor","backgroundColor":"backgroundColor","customBackgroundColor":"customBackgroundColor","showSubmenuIcon":"showSubmenuIcon","openSubmenusOnClick":"openSubmenusOnClick","menuColors":"menuColors","submenuColors":"submenuColors","style":"style","orientation":"orientation"},"supports":{"align":["wide","full"],"anchor":true,"html":false,"inserter":true,"__experimentalLayout":{"allowSwitching":false,"allowInheriting":false,"default":{"type":"flex"}}},"editorScript":"file:./build/index.js","editorStyle":"file:./build/index.css","style":"file:./build/style-index.css"}');
