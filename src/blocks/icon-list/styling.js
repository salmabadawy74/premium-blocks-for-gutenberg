...
function styling(props) {
  ...
  selectors = {
    ...
    " .premium-icon-list__icon-wrap": {
      ...
      "margin-right":
        iconPosition == "left"
          ? generateCSSUnit(iconSpacing, iconSpacingType)
          : "",
      "margin-left":
        iconPosition == "right"
          ? generateCSSUnit(iconSpacing, iconSpacingType)
  ...
  mobile_selectors = {
    ...
    " .premium-icon-list__icon-wrap": {
      ...
      "margin-right":
        iconPosition == "left"
          ? generateCSSUnit(iconSpacingMobile, iconSpacingType)
          : "",
      "margin-left":
        iconPosition == "right"
          ? generateCSSUnit(iconSpacingMobile, iconSpacingType)
  ...
  tablet_selectors = {
    ...
    " .premium-icon-list__icon-wrap": {
      ...
      "margin-right":
        iconPosition == "left"
          ? generateCSSUnit(iconSpacingTablet, iconSpacingType)
          : "",
      "margin-left":
        iconPosition == "right"
          ? generateCSSUnit(iconSpacingTablet, iconSpacingType)
  ...
  icons.map((icon, index) => {
    ...
    selectors[
      " .premium-icon-list-content" +
        index +
        ":hover .premium-icon-list__content-icon"
    ] = {
    ...
    selectors[
      " .premium-icon-list-content" +
        index +
        ":hover .premium-icon-list__content-icon i"
    ] = {
      fill: icon.icon_hover_color,
    };

    selectors[
      " .premium-icon-list-content" + index + " .premium-icon-list__label"
    ] = {
    ...
    selectors[
      " .premium-icon-list-content" + index + ":hover .premium-icon-list__label"
    ] = {
    ...
    selectors[
      " .premium-icon-list-content" +
        index +
        ":hover .premium-icon-list__content-wrap"
    ] = {
      background: icon.item_bg_hover_color,
    };

    selectors[
      " .premium-icon-list-content" + index + " .premium-icon-list__icon-wrap"
    ] = {
    ...
    selectors[
      " .premium-icon-list-content" +
        index +
        ":hover .premium-icon-list__icon-wrap"
    ] = {
    ...
    selectors[
      " .premium-icon-list-content" +
        index +
        " .premium-icon-list__content-wrap"
    ] = {
      background: icon.item_bg_color,
      "margin-top":
        layoutPos == "block" ? generateCSSUnit(marginTop, marginTopType) : "",
      "margin-bottom":
        layoutPos == "block"
          ? generateCSSUnit(marginBottom, marginBottomType)
          : "",
      "margin-right":
        layoutPos == "block"
          ? ""
          : generateCSSUnit(marginRight, marginRightType),
      "margin-left":
        layoutPos == "block" ? "" : generateCSSUnit(marginLeft, marginLeftType),
    };
    ...
    mobile_selectors[
      ...
      "margin-top":
        layoutPos == "block"
          ? generateCSSUnit(marginTopMobile, marginTopType)
          : "",
      "margin-top":
        layoutPos == "block"
          ? generateCSSUnit(marginBottomMobile, marginBottomType)
          : "",
      "margin-right":
        layoutPos == "block"
          ? ""
          : generateCSSUnit(marginRightMobile, marginRightType),
      "margin-left":
        layoutPos == "block"
          ? ""
          : generateCSSUnit(marginLeftMobile, marginLeftType),
    };
    ...
    tablet_selectors[
      ...
      "margin-top":
        layoutPos == "block"
          ? generateCSSUnit(marginTopTablet, marginTopType)
          : "",
      "margin-top":
        layoutPos == "block"
          ? generateCSSUnit(marginBottomTablet, marginBottomType)
          : "",
      "margin-right":
        layoutPos == "block"
          ? ""
          : generateCSSUnit(marginRightTablet, marginRightType),
      "margin-left":
        layoutPos == "block"
          ? ""
          : generateCSSUnit(marginLeftTablet, marginLeftType),
    };
  });
