...
const deprecated = {
    ...
    migrate: (attributes) => {
        let newAttributes = {
            "titleStyles":
            {
                "titleColor": attributes.titleStyles['titleColor'] ? attributes.titleStyles['titleColor'] : "",
                "shinyColor": attributes.titleStyles['shinyColor'] ? attributes.titleStyles['shinyColor'] : "#fff",
                "blurColor": attributes.titleStyles['blurColor'] ? attributes.titleStyles['blurColor'] : "#000",
                "BGColor": attributes.titleStyles['BGColor'] ? attributes.titleStyles['BGColor'] : "#EAEAEA",
                "lineColor": attributes.titleStyles['lineColor'] ? attributes.titleStyles['lineColor'] : "var(--pbg-global-color1,#0085BA)",
                "triangleColor": attributes.titleStyles['triangleColor'] ? attributes.titleStyles['triangleColor'] : "var(--pbg-global-color1,#0085BA)",
                "stripeColor": attributes.titleStyles['stripeColor'] ? attributes.titleStyles['stripeColor'] : "var(--pbg-global-color1,#0085BA)",
                "blurShadow": attributes.titleStyles['blurShadow'] ? attributes.titleStyles['blurShadow'] : "120",
                "animateDelay": attributes.titleStyles['animateDelay'] ? attributes.titleStyles['animateDelay'] : "2",
                "animateduration": attributes.titleStyles['animateduration'] ? attributes.titleStyles['animateduration'] : "1"
            }
        }
