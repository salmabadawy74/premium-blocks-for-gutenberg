...
function Navigation({
    ...
    useEffect(() => {
        ...
        if (createNavigationMenuStatus === CREATE_NAVIGATION_MENU_ERROR) {
            showNavigationMenuCreateNotice(
                __('Failed to create Navigation Menu.', "premium-blocks-for-gutenberg")
            );
        }
    }, [
            ...
            <div {...blockProps}>
                <Warning>
                    ...
                    <Button onClick={resetToEmptyBlock} variant="link">
                        {__('Create a new menu?', "premium-blocks-for-gutenberg")}
                    </Button>
                </Warning>
            </div>
        );
    ...
    if (isEntityAvailable && hasAlreadyRendered) {
        return (
            <div {...blockProps}>
                <Warning>
                    {__('Block cannot be rendered inside itself.', "premium-blocks-for-gutenberg")}
                </Warning>
            </div>
        );
    }
                ...
                <InspectorControls>
                    <InspectorTabs tabs={['layout', 'style', 'advance']}>
                        <InspectorTab key={'layout'}>
                            <PanelBody title={__('Display', "premium-blocks-for-gutenberg")}>
                                {(
                                    <>
                                        {isResponsive && (
                                            <Button
                                            ...
                                            >
                                                ...
                                                {!hasIcon && (
                                                    <span>{__('Menu', "premium-blocks-for-gutenberg")}</span>
                                                )}
                                            </Button>
                                        )}
                                        {overlayMenuPreview && (
                                            <ToggleControl
                                                label={__('Show icon button', "premium-blocks-for-gutenberg")}
                                                help={__(
                                        ...
                                        <h3>{__('Overlay Menu', "premium-blocks-for-gutenberg")}</h3>
                                        <ToggleGroupControl
                                            label={__('Configure overlay menu', "premium-blocks-for-gutenberg")}
                                            value={overlayMenu}
                                            help={__(
                                                'Collapses the navigation options in a menu icon opening an overlay.', "premium-blocks-for-gutenberg"
                                            )}
                                            onChange={(value) =>
                                        ...
                                        >
                                            <ToggleGroupControlOption
                                                value="never"
                                                label={__('Off', "premium-blocks-for-gutenberg")}
                                            />
                                            <ToggleGroupControlOption
                                                value="mobile"
                                            ...
                                            <ToggleGroupControlOption
                                                value="always"
                                                label={__('Always', "premium-blocks-for-gutenberg")}
                                            />
                                            <ToggleGroupControlOption
                                                value="custom"
                                        ...
                                        {overlayMenu !== 'never' && (
                                            <>
                                                <h3>{__('Overlay Menu Style', "premium-blocks-for-gutenberg")}</h3>
                                                <ToggleGroupControl
                                                    label={__('Overlay menu styles', "premium-blocks-for-gutenberg")}
                                        ...
                                        {hasSubmenus && hasSubmenuIndicatorSetting && (
                                            <>
                                                <h3>{__('Submenus', "premium-blocks-for-gutenberg")}</h3>
                                                <ToggleControl
                                                    ...
                                                    label={__('Open on click', "premium-blocks-for-gutenberg")}
                                                />
                                                ...
                                                <ToggleControl
                                                    ...
                                                    label={__('Show arrow', "premium-blocks-for-gutenberg")}
                                                />
                                            </>
                                        )}
                                    </>
                        ...
                        <InspectorTab key={'style'}>
                            <PanelBody title={__('Menu', "premium-blocks-for-gutenberg")}>
                                ...
                                />
                                <hr />
                                <SpacingComponent value={margin} responsive={true} showUnits={true} label={__('Menu Margin', "premium-blocks-for-gutenberg")} onChange={(value) => onChangeSpacing({ margin: value })} />
                                <SpacingComponent value={padding} responsive={true} showUnits={true} label={__('Menu Padding', "premium-blocks-for-gutenberg")} onChange={(value) => onChangeSpacing({ padding: value })} />
                                <SpacingComponent value={itemPadding} responsive={true} showUnits={true} label={__('Menu Item Padding', "premium-blocks-for-gutenberg")} onChange={(value) => onChangeSpacing({ itemPadding: value })} />
                            </PanelBody>
                            <PanelBody title={__('Overlay Menu', "premium-blocks-for-gutenberg")}>
                                <TabPanel
                                    className="premium-color-tabpanel"
                                    activeClass="active-tab"
                                    tabs={[
                            ...
                            {hasSubmenus && hasSubmenuIndicatorSetting && (
                                <>
                                    <PanelBody title={__('Submenu', "premium-blocks-for-gutenberg")}>
