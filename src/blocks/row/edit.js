            ...
            <InspectorControls>
                <InspectorTabs tabs={['layout', 'style', 'advance']}>
                    <InspectorTab key={'layout'}>
                        ...
                        >
                            {isBlockRootParent && <SelectControl
                            ...
                            {!isBlockRootParent &&
                                <ResponsiveRangeControl
                                    label={__("Custom Width", 'premium-blocks-for-gutenberg')}
                                    value={colWidth}
                                    min="0"
                                    max="160"
                        ...
                        >
                            ...
                            <ResponsiveRadio
                                choices={[
                                    ...
                                    {
                                        value: 'nowrap',
                                        tooltip: __('No Wrap', 'premium-blocks-for-gutenberg'),
                                    ...
                                    {
                                        value: 'wrap-reverse',
                                        tooltip: __('Wrap Reverse', 'premium-blocks-for-gutenberg'),
                    ...
                    <InspectorTab key={'advance'}>
                        ...
                        >
                            ...
                            />
                            <ResponsiveRangeControl
                                label={__("Row Gutter", 'premium-blocks-for-gutenberg')}
                                value={rowGutter}
                                min="0"
                                max="100"
                                onChange={newValue => setAttributes({ rowGutter: newValue })}
                                defaultValue={0}
                                showUnit={true}
                            />
                            <SpacingControl
