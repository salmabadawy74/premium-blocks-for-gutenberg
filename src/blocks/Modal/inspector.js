                ...
                <InspectorTab key={"layout"}>
                    ...
                    >
                        <ToggleControl
                            ...
                            onChange={(value) =>
                                saveContentStyle({ showHeader: value })
                            }
                        />
                        {contentStyles[0].showHeader && (
                            <ToggleControl
                                ...
                                onChange={(value) =>
                                    saveContentStyle({ showUpperClose: value })
                                }
                            />
                        )}
                        <ToggleControl
                        ...
                        <SelectControl
                            ...
                            onChange={(value) =>
                                saveModalStyles({ contentType: value })
                            }
                            options={[
                                {
                                    value: "text",
                    ...
                    {contentStyles[0].showHeader && (
                        ...
                        >
                            <TextControl
                                ...
                                onChange={(value) =>
                                    saveContentStyle({ titleText: value })
                                }
                            />
                            <SelectControl
                                label={__(
                                ...
                                onChange={(value) =>
                                    saveContentStyle({ iconType: value })
                                }
                            />
                    ...
                    {contentStyles[0].showLowerClose && (
                        ...
                        >
                            <TextControl
                                ...
                                onChange={(value) =>
                                    saveContentStyle({ lowerCloseText: value })
                                }
                            />
                        </PanelBody>
                    )}
                ...
                <InspectorTab key={"style"}>
                    ...
                    {contentStyles[0].showHeader && (
                        ...
                        >
                            ...
                            <AdvancedPopColorControl
                                ...
                                colorDefault={""}
                                onColorChange={(newValue) =>
                                    saveHeaderStyles({ color: newValue })
                                }
                            />
                            <AdvancedPopColorControl
                                label={__(
                                ...
                                colorDefault={""}
                                onColorChange={(newValue) =>
                                    saveHeaderStyles({ backColor: newValue })
                                }
                            />
                            <PremiumBorder
                                label={__(
                                ...
                                value={headerBorder}
                                onChange={(value) =>
                                    setAttributes({ headerBorder: value })
                                }
                            />
                        </PanelBody>
                    )}
                    ...
                    {contentStyles[0].showLowerClose && (
                        ...
                        >
                            <ResponsiveRangeControl
                                ...
                                onChange={(value) =>
                                    setAttributes({ lowerIconWidth: value })
                                }
                                min={1}
                                max={500}
                                step={1}
                            ...
                            <PremiumTypo
                                ...
                                onChange={(newValue) =>
                                    setAttributes({ lowerTypography: newValue })
                                }
                            />
                            <AdvancedPopColorControl
                                label={__(
                            ...
                            <AdvancedPopColorControl
                                ...
                                onColorChange={(newvalue) =>
                                    saveLowerStyles({ backColor: newvalue })
                                }
                                colorDefault={``}
                            />
                            <PremiumBorder
                                ...
                                value={lowerBorder}
                                onChange={(value) =>
                                    setAttributes({ lowerBorder: value })
                                }
                            />
                            <hr />
                            <SpacingControl
                                ...
                                value={lowerPadding}
                                onChange={(value) =>
                                    setAttributes({ lowerPadding: value })
                                }
                                showUnits={true}
                                responsive={true}
                            />
                    ...
                    >
                        ...
                        <SpacingControl
                            ...
                            value={modalMargin}
                            onChange={(value) =>
                                setAttributes({ modalMargin: value })
                            }
                            showUnits={true}
                            responsive={true}
                        />
