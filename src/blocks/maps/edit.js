...
function Edit(props) {
    ...
    const initMap = () => {
        ...
        if (typeof google === "undefined" || !blockId) return null;
        ...
        if (!map) {
            let mapElem = contentRef.current.querySelector(".map-container");
                        ...
                        <InspectorTab key={"layout"}>
                            ...
                            >
                                <TextControl
                                    ...
                                    help={[
                                        __(
                                            "Get your location coordinates from",
                                            "premium-blocks-for-gutenberg"
                                        ),
                                        <a
                                    ...
                                    onChange={(newLng) =>
                                        setAttributes({ centerLng: newLng })
                                    }
                                />
                                <TextControl
                                    label={__(
                                    ...
                                    value={centerLat}
                                    onChange={(newLat) =>
                                        setAttributes({ centerLat: newLat })
                                    }
                                />
                            </PanelBody>
                            <PanelBody
                            ...
                            >
                                <ToggleControl
                                    ...
                                    checked={mapMarker}
                                    onChange={(check) =>
                                        setAttributes({ mapMarker: check })
                                    }
                                    help={__(
                                        "Disable marker is applied on page reload",
                                        "premium-blocks-for-gutenberg"
                                    )}
                                />
                                {mapMarker && (
                            ...
                            >
                                ...
                                <ToggleControl
                                    ...
                                    onChange={(check) =>
                                        setAttributes({ mapTypeControl: check })
                                    }
                                />
                                <ToggleControl
                                    label={__(
                                    ...
                                    checked={zoomControl}
                                    onChange={(check) =>
                                        setAttributes({ zoomControl: check })
                                    }
                                />
                                <ToggleControl
                                    label={__(
                                ...
                                <ToggleControl
                                    ...
                                    checked={scrollwheel}
                                    onChange={(check) =>
                                        setAttributes({ scrollwheel: check })
                                    }
                                />
                            </PanelBody>
                            <PanelBody
                        ...
                        <InspectorTab key={"style"}>
                            ...
                            {mapMarker && markerDesc && (
                                ...
                                >
                                    <PremiumTypo
                                        ...
                                        onChange={(newValue) =>
                                            setAttributes({
                                                descriptionTypography: newValue,
                                            })
                                        }
                                    />
                                    <AdvancedPopColorControl
                            ...
                            >
                                <PremiumShadow
                                    ...
                                    value={mapBoxShadow}
                                    onChange={(value) =>
                                        setAttributes({ mapBoxShadow: value })
                                    }
                                />
                                <hr />
                                <PremiumBorder
                                ...
                                <SpacingComponent
                                    ...
                                    onChange={(value) =>
                                        setAttributes({ mapPadding: value })
                                    }
                                />
                            </PanelBody>
                        </InspectorTab>
