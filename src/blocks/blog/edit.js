...
function Edit(props) {
    useEffect(() => {
        setAttributes({
            blockId: "premium-blog-" + generateBlockId(clientId),
        });
    }, []);
    const orderSelect = [
                ...
                <InspectorTab key={"layout"}>
                    ...
                    >
                        ...
                        {gridCheck && [
                            ...
                            //             className:
                            //                 "premium-desktop-tab premium-responsive-tabs",
                            //         },
                            //         {
                            //             name: "tablet",
                            //             title: <Dashicon icon="tablet" />,
                            //             className:
                            //                 "premium-tablet-tab premium-responsive-tabs",
                            //         },
                            //         {
                            //             name: "desktop",
                            //             title: <Dashicon icon="smartphone" />,
                            //             className:
                            //                 "premium-mobile-tab premium-responsive-tabs",
                            //         },
                            //     ]}
                            // >
                            //     {(tab) => {
                    ...
                    >
                        ...
                        <ToggleControl
                            ...
                            onChange={() =>
                                setAttributes({ currentPost: !currentPost })
                            }
                        />
                        <hr />
                        <SelectControl
                    ...
                    >
                        ...
                        <IconButton
                            ...
                            label="Left"
                            onClick={() =>
                                setAttributes({ filterPosition: "left" })
                            }
                        ...
                        <IconButton
                            ...
                            label="Right"
                            onClick={() =>
                                setAttributes({ filterPosition: "center" })
                            }
                        ...
                        <IconButton
                            ...
                            label="Right"
                            onClick={() =>
                                setAttributes({ filterPosition: "right" })
                            }
                                ...
                                <Fragment>
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(slideSpacingValue) =>
                                            setAttributes({
                                                slideSpacing: slideSpacingValue,
                                            })
                                        }
                                    />
                                    <ToggleControl
                ...
                <InspectorTab key={"style"}>
                    ...
                    >
                        <PremiumTypo
                            ...
                            onChangeWeight={(newWeight) =>
                                setAttributes({
                                    postContentWeight: newWeight || 500,
                                })
                            }
                            onChangeStyle={(newStyle) =>
                    ...
                    >
                        <PremiumTypo
                            ...
                            onChangeStyle={(newStyle) =>
                                setAttributes({ tagsStyle: newStyle })
                            }
                            onChangeSpacing={(newValue) =>
                                setAttributes({ tagsLetter: newValue })
                            }
                            onChangeUpper={(check) =>
                                setAttributes({ tagsUpper: check })
                            }
                        />
                        <ColorPalette
                            label={__("Tag Color")}
                        ...
                        <ColorPalette
                            ...
                            onChange={(newHoverTag) =>
                                setAttributes({ hoverTag: newHoverTag })
                            }
                        />
                    </PanelBody>
                    ,
                    {excerptType === "Link" ? (
                        ...
                        >
                            <PremiumTypo
                                ...
                                onChangeUpper={(check) =>
                                    setAttributes({ buttonUpper: check })
                                }
                            />
                            <PremiumRange
                                setAttributes={setAttributes}
