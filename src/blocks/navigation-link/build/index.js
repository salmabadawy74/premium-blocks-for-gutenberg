...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./block.json */ "./navigation-link/block.json");
...
function NavigationLinkEdit(_ref2) {
  ...
  const {
    ...
    return {
      ...
      isAtMaxNesting: getBlockParentsByBlockName(clientId, [_block_json__WEBPACK_IMPORTED_MODULE_15__.name, 'premium/navigation-submenu']).length >= MAX_NESTING,
