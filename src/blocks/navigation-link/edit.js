    ...
    return (
        <div className="link-control-transform">
            <h3 className="link-control-transform__subheading">
                {__('Transform', "premium-blocks-for-gutenberg")}
            </h3>
...
export default function NavigationLinkEdit({
    ...
    const itemLabelPlaceholder = __('Add link…', "premium-blocks-for-gutenberg");
    const ref = useRef();
    ...
    switch (type) {
        case 'post':
            ...
            missingText = __('Select post', "premium-blocks-for-gutenberg");
            break;
        case 'page':
            /* translators: label for missing page in navigation link block */
            missingText = __('Select page', "premium-blocks-for-gutenberg");
            break;
        case 'category':
            /* translators: label for missing category in navigation link block */
            missingText = __('Select category', "premium-blocks-for-gutenberg");
            break;
        case 'tag':
            /* translators: label for missing tag in navigation link block */
            missingText = __('Select tag', "premium-blocks-for-gutenberg");
            break;
        default:
            /* translators: label for missing values in navigation link block */
            missingText = __('Add link', "premium-blocks-for-gutenberg");
    }
                ...
                <ToolbarGroup>
                    ...
                    {!isAtMaxNesting && (
                        <ToolbarButton
                            name="submenu"
                            icon={addSubmenu}
                            title={__('Add submenu', "premium-blocks-for-gutenberg")}
                ...
                <a className={classes}>
                    ...
                    {!url ? (
                        <div className="premium-navigation-link__placeholder-text">
                            <Tooltip
                                position="top center"
                                text={__('This item is missing a link', "premium-blocks-for-gutenberg")}
                            >
