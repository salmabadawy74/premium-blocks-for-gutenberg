...
function Edit({ clientId, attributes, setAttributes, deviceType }) {
    ...
    useEffect(() => {
        ...
        setAttributes({
            blockId:
                "premium-price-" + generateBlockId(clientId),
        });
    }, []);
        ...
        <InspectorControls>
            <InspectorTabs tabs={["layout", "style", "advance"]}>
                <InspectorTab key={"layout"}>
                    ...
                    >
                        <MultiButtonsControl
                            choices={[{ value: 'flex-start', label: __('Left', "premium-blocks-for-gutenberg"), icon: Icons.alignLeft }, { value: 'center', label: __('Center', "premium-blocks-for-gutenberg"), icon: Icons.alignCenter }, { value: 'right', label: __('Right', "premium-blocks-for-gutenberg"), icon: Icons.alignRight }]}
                            value={align}
                        ...
                        <TextControl
                            ...
                            onChange={value => setAttributes({ slashedPriceText: value })}
                        />
                        <TextControl
                            label={__("Currency", 'premium-blocks-for-gutenberg')}
                            value={currencyText}
                            onChange={value => setAttributes({ currencyText: value })}
                        />
                        <TextControl
                        ...
                        <TextControl
                            ...
                            value={durationText}
                            onChange={value => setAttributes({ durationText: value })}
                        />
                    </PanelBody>
                </InspectorTab>
                <InspectorTab key={"style"}>
                    ...
                    <PanelBody
                        title={__("Slashed Price", "premium-blocks-for-gutenberg")}
                        className="premium-panel-body"
                        initialOpen={false}
                    >
                        <MultiButtonsControl
                            choices={ALIGNS}
                            value={slashedAlign}
                            onChange={(newAlign) => setAttributes({ slashedAlign: newAlign })}
                            label={__("Vertical Alignment", "premium-blocks-for-gutenberg")}
                            showIcons={true} />
                        <PremiumTypo
                            components={["responsiveSize", "weight", "family", "spacing", "style", "Upper", "line", "Decoration"]}
                            value={slashedTypography}
                            onChange={newValue => setAttributes({ slashedTypography: newValue })}
                        />
                        <AdvancedPopColorControl
                            label={__("Color", "premium-blocks-for-gutenberg")}
                            colorValue={slashedColor}
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ slashedColor: value })}
                        />
                        <AdvancedPopColorControl
                            label={__("Background Color", "premium-blocks-for-gutenberg")}
                            colorValue={slashedBgColor}
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ slashedBgColor: value })}
                        />
                    </PanelBody>
                    <PanelBody
                        title={__("Currency", "premium-blocks-for-gutenberg")}
                        className="premium-panel-body"
                        initialOpen={false}
                    >
                        <MultiButtonsControl
                            choices={ALIGNS}
                            value={currencyAlign}
                            onChange={(newAlign) => setAttributes({ currencyAlign: newAlign })}
                            label={__("Vertical Alignment", "premium-blocks-for-gutenberg")}
                            showIcons={true} />
                        <PremiumTypo
                            components={["responsiveSize", "weight", "family", "spacing", "style", "Upper", "line", "Decoration"]}
                            value={currencyTypography}
                            onChange={newValue => setAttributes({ currencyTypography: newValue })}
                        />
                        <AdvancedPopColorControl
                            label={__("Color", "premium-blocks-for-gutenberg")}
                            colorValue={currencyColor}
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ currencyColor: value })}
                        />
                        <AdvancedPopColorControl
                            label={__("Background Color", "premium-blocks-for-gutenberg")}
                            colorValue={currencyBgColor}
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ currencyBgColor: value })}
                        />
                    </PanelBody>
                    <PanelBody
                    ...
                    >
                        <MultiButtonsControl
                            choices={ALIGNS}
                            value={priceAlign}
                            onChange={(newAlign) => setAttributes({ priceAlign: newAlign })}
                            label={__("Vertical Alignment", "premium-blocks-for-gutenberg")}
                            showIcons={true} />
                        <PremiumTypo
                            components={["responsiveSize", "weight", "family", "spacing", "style", "Upper", "line", "Decoration"]}
                        ...
                        <AdvancedPopColorControl
                            ...
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ priceBgColor: value })}
                        />
                    </PanelBody>
                    <PanelBody
                    ...
                    >
                        <MultiButtonsControl
                            choices={ALIGNS}
                            value={dividerAlign}
                            onChange={(newAlign) => setAttributes({ dividerAlign: newAlign })}
                            label={__("Vertical Alignment", "premium-blocks-for-gutenberg")}
                            showIcons={true} />
                        <PremiumTypo
                            components={["responsiveSize", "weight", "family", "spacing", "style", "Upper", "line", "Decoration"]}
                        ...
                        <AdvancedPopColorControl
                            ...
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ dividerBgColor: value })}
                        />
                    </PanelBody>
                    <PanelBody
                        title={__("Duration", "premium-blocks-for-gutenberg")}
                        className="premium-panel-body"
                        initialOpen={false}
                    >
                        <MultiButtonsControl
                            choices={ALIGNS}
                            value={durationAlign}
                            onChange={(newAlign) => setAttributes({ durationAlign: newAlign })}
                            label={__("Vertical Alignment", "premium-blocks-for-gutenberg")}
                            showIcons={true} />
                        <PremiumTypo
                            components={["responsiveSize", "weight", "family", "spacing", "style", "Upper", "line", "Decoration"]}
                        ...
                        <AdvancedPopColorControl
                            ...
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ durationColor: value })}
                        />
                        <AdvancedPopColorControl
                            label={__("Background Color", "premium-blocks-for-gutenberg")}
                            colorValue={durationBgColor}
                            colorDefault={""}
                            onColorChange={(value) => setAttributes({ durationBgColor: value })}
                        />
                    </PanelBody>
                </InspectorTab>
