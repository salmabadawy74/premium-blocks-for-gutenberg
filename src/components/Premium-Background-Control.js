    ...
    const bgType = [
        {
            ...
            icon: (
                ...
                >
                    <defs></defs>
                    <title>classic-background-icon</title>
                    <g id="Classic_Background" data-name="Classic Background">
                        <path
                            class="cls-1"
        ...
        },
        {
            ...
            icon: (
                ...
                >
                    <defs></defs>
                    <title>gradient-background-icon</title>
                    <path
                        class="cls-1"
    ...
    if (backgroundVedio) {
        bgType.push({
            ...
            icon: (
                ...
                >
                    <defs></defs>
                    <title>video-background-icon</title>
                    <path
                        class="cls-1"
                ...
                <div className="premium-inner-sub-section premium-blocks__base-control">
                    <PremiumBackground
                        ...
                        onChangeColor={(newValue) =>
                            onChangeBackground("backgroundColor", newValue)
                        }
                    />
                    <PremiumBackground
                        ...
                        onRemoveImage={() =>
                            onChangeBackground("backgroundImageURL", "")
                        }
                        onChangeBackPos={(newValue) =>
                            onChangeBackground("backgroundPosition", newValue)
                        }
                        onchangeBackRepeat={(newValue) =>
                            onChangeBackground("backgroundRepeat", newValue)
                        }
                        onChangeBackSize={(newValue) =>
                            onChangeBackground("backgroundSize", newValue)
                        }
                        onChangeFixed={(check) =>
                            onChangeBackground("fixed", check)
                        }
                    />
                </div>
            )}
            {"gradient" === backgroundType && (
                <div className="Premium-inner-sub-section premium-blocks__base-control">
                    ...
                    <ResponsiveSingleRangeControl
                        ...
                        onChange={(value) =>
                            onChangeBackground("gradientLocationOne", value)
                        }
                        showUnit={false}
                        defaultValue={0}
                    />
                    <AdvancedPopColorControl
                        ...
                        colorDefault={"#777777"}
                        onColorChange={(value) =>
                            onChangeBackground("gradientColorTwo", value)
                        }
                    />
                    <ResponsiveSingleRangeControl
                        label={__("Location", "premium-blocks-for-gutenberg")}
                        ...
                        onChange={(value) =>
                            onChangeBackground("gradientLocationTwo", value)
                        }
                        showUnit={false}
                        defaultValue={0}
                    />
                    <div className="premium-btn-size-settings-container">
                        <h2 className="premium-beside-btn-group">
                            {__(
                                "Gradient Type",
                                "premium-blocks-for-gutenberg"
                            )}
                        ...
                        >
                            {map(gradTypes, ({ name, key }) => (
                                <Button
                                    ...
                                    onClick={() =>
                                        onChangeBackground("gradientType", key)
                                    }
                                >
                                    {name}
                                </Button>
                    ...
                    {"radial" !== gradientType && (
                        <ResponsiveSingleRangeControl
                            ...
                            value={gradientAngle}
                            onChange={(value) =>
                                onChangeBackground("gradientAngle", value)
                            }
                            showUnit={false}
                            defaultValue={0}
                            min={0}
                    ...
                    {"radial" === gradientType && (
                        <SelectControl
                            ...
                            onChange={(value) =>
                                onChangeBackground("gradientPosition", value)
                            }
                        />
                    )}
                </div>
            ...
            {"video" === backgroundType && (
                <Fragment>
                    <SelectControl
                        ...
                        onChange={(val) =>
                            onChangeBackground("videoSource", val)
                        }
                    />
                    {videoSource === "external" ? (
                        <TextControl
                            ...
                            onChange={(val) =>
                                onChangeBackground("bgExternalVideo", val)
                            }
                        />
                    ) : (
                            <Fragment>
