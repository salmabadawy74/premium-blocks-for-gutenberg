...
const { Tooltip, Dropdown, SlotFillProvider, CheckboxControl, ToggleControl } =
    wp.components;
...
class Shape extends Component {
    ...
    setSettings(type, val) {
        ...
        onChange(
            Object.assign({}, value, styleVal, { shapeType }, { [type]: val })
        );
    }
    ...
    renderShapeOptions = () => {
        ...
        if (value.style) {
            shapes = shapes.filter(
                (item) =>
                    item.toLowerCase().search(value.style.toLowerCase()) == -1
            );
            ...
            <div className="premium-field-shape premium-field">
                <div className="premium-field-child">
                    <div className="premium-field premium-shape-picker-wrapper">
                        <SlotFillProvider>
                            <Dropdown
                                className={`premium-field-child premium-shape-picker ${
                                    value.style ? "has-value" : ""
                                }`}
                    ...
                    {value.openShape == 1 && (
                        <Fragment>
                            ...
                            <ResponsiveRangeControl
                                ...
                                onChangeTablet={(val) =>
                                    this.setSettings("widthTablet", val)
                                }
                            ...
                            <ResponsiveRangeControl
                                ...
                                onChangeTablet={(val) =>
                                    this.setSettings("heightTablet", val)
                                }
