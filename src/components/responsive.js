...
function Responsive(props) {
    let previewDevice = wp.data &&
        wp.data.select &&
        (wp.data.select('core/edit-post') || wp.data.select('core/edit-site')) &&
