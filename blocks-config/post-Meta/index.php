...
function render_meta_author($attributes, $postID)
{
    ...
    <div class="premium-blog-post-author premium-blog-meta-data">
        <span>
            <svg width="800px" height="800px" viewBox="0 0 25 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function render_meta_comment($attributes, $postID)
{
    ...
    <div class='premium-blog-post-comments premium-blog-meta-data'>
        <span class="premium-post__comment">
            <svg width="800px" height="800px" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
