...
class PBG_Blocks_Helper {
	...
	public function __construct() {
		...
		add_action( 'pbg_get_css_files', array( $this, 'add_blocks_editors_style' ) );
	}

	public function add_blocks_editors_style() {
		...
		if ( $is_icon_enabled ) {
			Pbg_Style_Generator::pbg_add_css( PREMIUM_BLOCKS_URL . 'assets/css/minified/icon.min.css' );
		}
		if ( $is_dual_heading_enabled ) {
			Pbg_Style_Generator::pbg_add_css( PREMIUM_BLOCKS_URL . 'assets/css/minified/dualHeading.min.css' );
		}

		if ( $is_banner_enabled ) {
			Pbg_Style_Generator::pbg_add_css( PREMIUM_BLOCKS_URL . 'assets/css/minified/banner.min.css' );
		}
	}
	...
	public function pbg_frontend() {
		...
		// PREMIUM_BLOCKS_VERSION
		// );
		// Pbg_Style_Generator::pbg_add_css( PREMIUM_BLOCKS_URL . 'assets/css/minified/dual-heading.min.css' );
		// }
	...
	public function on_init() {
		...
		register_block_type(
			...
			array(
				...
				'editor_style'    => 'pbg-editor-icon-style',
				'editor_script'   => 'pbg-blocks-js',
	...
	public function get_dual_css_style( $attr, $unique_id ) {
		...
		if ( isset( $attr['firstTypography'] ) ) {
			...
			$css->set_selector( $unique_id . '> .premium-dheading-block__wrap' . ' > .premium-dheading-block__title' . ' > .premium-dheading-block__first' );
			$css->render_typography( $attr['firstTypography'], 'Tablet' );
		}
		...
		if ( isset( $attr['firstTypography'] ) ) {
			...
			$css->set_selector( $unique_id . '> .premium-dheading-block__wrap' . ' > .premium-dheading-block__title' . ' > .premium-dheading-block__first' );
			$css->render_typography( $attr['firstTypography'], 'Mobile' );
		}
