...
class PBG_Blocks_Helper
{
	...
	public function pbg_frontend()
	{
		...
		if ($is_icon_box_enabled) {
			...
			wp_enqueue_script(
				'Tilt-js',
				PREMIUM_BLOCKS_URL . 'assets/js/tilt.js',
				array('jquery'),
				PREMIUM_BLOCKS_VERSION,
				true
			);
...
<?php
	...
	public static function get_iconbox_css($attr, $id)
	{
		...
		$selectors = array(
			' '                          => array(
				'margin-top'     => self::get_css_value($attr['outerMarginT'], 'px'),
				'margin-right'   => self::get_css_value($attr['outerMarginR'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['outerMarginB'], 'px'),
				'margin-left'    => self::get_css_value($attr['outerMarginL'], 'px'),
				'padding-top'    => self::get_css_value($attr['outerPaddingT'], $attr['paddingU']),
				'padding-right'  => self::get_css_value($attr['outerPaddingR'], $attr['paddingU']),
				'padding-bottom' => self::get_css_value($attr['outerPaddingB'], $attr['paddingU']),
				'padding-left'   => self::get_css_value($attr['outerPaddingL'], $attr['paddingU']),
			),
			' .premium-icon-box'         => array(
				'margin-top'     => self::get_css_value($attr['marginT'], 'px'),
				'margin-right'   => self::get_css_value($attr['marginR'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['marginB'], 'px'),
				'margin-left'    => self::get_css_value($attr['marginL'], 'px'),
			...
			' .premium-icon-box__icon'   => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTop'], $attr['iconMarginType']),
				'margin-right'   => self::get_css_value($attr['iconMarginRight'], $attr['iconMarginType']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottom'], $attr['iconMarginType']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeft'], $attr['iconMarginType']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTop'], $attr['iconPaddingType']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRight'], $attr['iconPaddingType']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottom'], $attr['iconPaddingType']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeft'], $attr['iconPaddingType']),
			),
			' .premium-icon-box:hover .premium-icon-box__icon ' => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTopH'], $attr['iconMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['iconMarginRightH'], $attr['iconMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottomH'], $attr['iconMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeftH'], $attr['iconMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTopH'], $attr['iconPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRightH'], $attr['iconPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottomH'], $attr['iconPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeftH'], $attr['iconPaddingTypeH']),
			),
			...
			' .premium-icon-box-label'   => array(
				'font-size'     => self::get_css_value($attr['labelSize'], $attr['labelSizeUnit']),
				'margin-top'    => self::get_css_value($attr['labelMarginTop'], $attr['labelMarginType']),
				'margin-right'  => self::get_css_value($attr['labelMarginRight'], $attr['labelMarginType']),
				'margin-bottom' => self::get_css_value($attr['labelMarginBottom'], $attr['labelMarginType']),
				'margin-left'   => self::get_css_value($attr['labelMarginLeft'], $attr['labelMarginType']),
			),
			' .premium-icon-box__desc'   => array(
				'font-size'      => self::get_css_value($attr['descSize'], $attr['descSizeUnit']),
				'margin-top'     => self::get_css_value($attr['descMarginTop'], $attr['descMarginType']),
				'margin-right'   => self::get_css_value($attr['descMarginRight'], $attr['descMarginType']),
				'margin-bottom'  => self::get_css_value($attr['descMarginBottom'], $attr['descMarginType']),
				'margin-left'    => self::get_css_value($attr['descMarginLeft'], $attr['descMarginType']),
				'padding-top'    => self::get_css_value($attr['descPaddingTop'], $attr['descPaddingType']),
				'padding-right'  => self::get_css_value($attr['descPaddingRight'], $attr['descPaddingType']),
				'padding-bottom' => self::get_css_value($attr['descPaddingBottom'], $attr['descPaddingType']),
				'padding-left'   => self::get_css_value($attr['descPaddingLeft'], $attr['descPaddingType']),
			),
			...
			' .premium-icon-box__btn_wrap:hover .premium-icon-box__btn' => array(
				'margin-top'     => self::get_css_value($attr['btnMarginTopH'], $attr['btnMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['btnMarginRightH'], $attr['btnMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['btnMarginBottomH'], $attr['btnMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['btnMarginLeftH'], $attr['btnMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['btnPaddingTopH'], $attr['btnPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['btnPaddingRightH'], $attr['btnPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['btnPaddingBottomH'], $attr['btnPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['btnPaddingLeftH'], $attr['btnPaddingTypeH']),
			),
		);
		// Desktop Icon Size CSS ends.
		...
		$t_selectors = array(
			' '                          => array(
				'margin-top'     => self::get_css_value($attr['outerMarginTTablet'], 'px'),
				'margin-right'   => self::get_css_value($attr['outerMarginRTablet'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['outerMarginBTablet'], 'px'),
				'margin-left'    => self::get_css_value($attr['outerMarginLTablet'], 'px'),
				'padding-top'    => self::get_css_value($attr['outerPaddingTTablet'], $attr['paddingU']),
				'padding-right'  => self::get_css_value($attr['outerPaddingRTablet'], $attr['paddingU']),
				'padding-bottom' => self::get_css_value($attr['outerPaddingBTablet'], $attr['paddingU']),
				'padding-left'   => self::get_css_value($attr['outerPaddingLTablet'], $attr['paddingU']),
			),
			' .premium-icon-box'         => array(
				'margin-top'     => self::get_css_value($attr['marginTTablet'], 'px'),
				'margin-right'   => self::get_css_value($attr['marginRTablet'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['marginBTablet'], 'px'),
				'margin-left'    => self::get_css_value($attr['marginLTablet'], 'px'),
			...
			' .premium-icon-box__icon'   => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTopTablet'], $attr['iconMarginType']),
				'margin-right'   => self::get_css_value($attr['iconMarginRightTablet'], $attr['iconMarginType']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottomTablet'], $attr['iconMarginType']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeftTablet'], $attr['iconMarginType']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTopTablet'], $attr['iconPaddingType']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRightTablet'], $attr['iconPaddingType']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottomTablet'], $attr['iconPaddingType']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeftTablet'], $attr['iconPaddingType']),
			),
			' .premium-icon-box:hover .premium-icon-box__icon ' => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTopTabletH'], $attr['iconMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['iconMarginRightTabletH'], $attr['iconMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottomTabletH'], $attr['iconMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeftTabletH'], $attr['iconMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTopTabletH'], $attr['iconPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRightTabletH'], $attr['iconPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottomTabletH'], $attr['iconPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeftTabletH'], $attr['iconPaddingTypeH']),
			),

			'  .premium-icon-box__title' => array(
				'font-size'      => self::get_css_value($attr['titleSizeTablet'], $attr['titleSizeUnit']),
				'margin-top'     => self::get_css_value($attr['titleMarginTopTablet'], $attr['titleMarginType']),
				'margin-right'   => self::get_css_value($attr['titleMarginRightTablet'], $attr['titleMarginType']),
				'margin-bottom'  => self::get_css_value($attr['titleMarginBottomTablet'], $attr['titleMarginType']),
				'margin-left'    => self::get_css_value($attr['titleMarginLeftTablet'], $attr['titleMarginType']),
				'padding-top'    => self::get_css_value($attr['titlePaddingTopTablet'], $attr['titlePaddingType']),
				'padding-right'  => self::get_css_value($attr['titlePaddingRightTablet'], $attr['titlePaddingType']),
				'padding-bottom' => self::get_css_value($attr['titlePaddingBottomTablet'], $attr['titlePaddingType']),
				'padding-left'   => self::get_css_value($attr['titlePaddingLeftTablet'], $attr['titlePaddingType']),
			),
			' .premium-icon-box-label'   => array(
				'font-size'     => self::get_css_value($attr['labelSizeTablet'], $attr['labelSizeUnit']),
				'margin-top'    => self::get_css_value($attr['labelMarginTopTablet'], $attr['labelMarginType']),
				'margin-right'  => self::get_css_value($attr['labelMarginRightTablet'], $attr['labelMarginType']),
				'margin-bottom' => self::get_css_value($attr['labelMarginBottomTablet'], $attr['labelMarginType']),
				'margin-left'   => self::get_css_value($attr['labelMarginLeftTablet'], $attr['labelMarginType']),
			),
			' .premium-icon-box__desc'   => array(
				'font-size'      => self::get_css_value($attr['descSizeTablet'], $attr['descSizeUnit']),
				'margin-top'     => self::get_css_value($attr['descMarginTopTablet'], $attr['descMarginType']),
				'margin-right'   => self::get_css_value($attr['descMarginRightTablet'], $attr['descMarginType']),
				'margin-bottom'  => self::get_css_value($attr['descMarginBottomTablet'], $attr['descMarginType']),
				'margin-left'    => self::get_css_value($attr['descMarginLeftTablet'], $attr['descMarginType']),
				'padding-top'    => self::get_css_value($attr['descPaddingTopTablet'], $attr['descPaddingType']),
				'padding-right'  => self::get_css_value($attr['descPaddingRightTablet'], $attr['descPaddingType']),
				'padding-bottom' => self::get_css_value($attr['descPaddingBottomTablet'], $attr['descPaddingType']),
				'padding-left'   => self::get_css_value($attr['descPaddingLeftTablet'], $attr['descPaddingType']),
			),
			' .premium-icon-box__btn'    => array(
				'font-size'      => self::get_css_value($attr['btnSizeTablet'], $attr['btnSizeUnit']),
				'margin-top'     => self::get_css_value($attr['btnMarginTopTablet'], $attr['btnMarginType']),
				'margin-right'   => self::get_css_value($attr['btnMarginRightTablet'], $attr['btnMarginType']),
				'margin-bottom'  => self::get_css_value($attr['btnMarginBottomTablet'], $attr['btnMarginType']),
				'margin-left'    => self::get_css_value($attr['btnMarginLeftTablet'], $attr['btnMarginType']),
				'padding-top'    => self::get_css_value($attr['btnPaddingTopTablet'], $attr['btnPaddingType']),
				'padding-right'  => self::get_css_value($attr['btnPaddingRightTablet'], $attr['btnPaddingType']),
				'padding-bottom' => self::get_css_value($attr['btnPaddingBottomTablet'], $attr['btnPaddingType']),
				'padding-left'   => self::get_css_value($attr['btnPaddingLeftTablet'], $attr['btnPaddingType']),
			),
			' .premium-icon-box__btn_wrap:hover .premium-icon-box__btn' => array(
				'margin-top'     => self::get_css_value($attr['btnMarginTopTabletH'], $attr['btnMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['btnMarginRightTabletH'], $attr['btnMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['btnMarginBottomTabletH'], $attr['btnMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['btnMarginLeftTabletH'], $attr['btnMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['btnPaddingTopTabletH'], $attr['btnPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['btnPaddingRightTabletH'], $attr['btnPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['btnPaddingBottomTabletH'], $attr['btnPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['btnPaddingLeftTabletH'], $attr['btnPaddingTypeH']),
			),
		);
		// Tablet CSS End.
		...
		$m_selectors = array(
			' '                          => array(
				'margin-top'     => self::get_css_value($attr['outerMarginTMobile'], 'px'),
				'margin-right'   => self::get_css_value($attr['outerMarginRMobile'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['outerMarginBMobile'], 'px'),
				'margin-left'    => self::get_css_value($attr['outerMarginLMobile'], 'px'),
				'padding-top'    => self::get_css_value($attr['outerPaddingTMobile'], $attr['paddingU']),
				'padding-right'  => self::get_css_value($attr['outerPaddingRMobile'], $attr['paddingU']),
				'padding-bottom' => self::get_css_value($attr['outerPaddingBMobile'], $attr['paddingU']),
				'padding-left'   => self::get_css_value($attr['outerPaddingLMobile'], $attr['paddingU']),
			),
			' .premium-icon-box'         => array(
				'margin-top'     => self::get_css_value($attr['marginTMobile'], 'px'),
				'margin-right'   => self::get_css_value($attr['marginRMobile'], 'px'),
				'margin-bottom'  => self::get_css_value($attr['marginBMobile'], 'px'),
				'margin-left'    => self::get_css_value($attr['marginLMobile'], 'px'),
			...
			' .premium-icon-box__icon'   => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTopMobile'], $attr['iconMarginType']),
				'margin-right'   => self::get_css_value($attr['iconMarginRightMobile'], $attr['iconMarginType']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottomMobile'], $attr['iconMarginType']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeftMobile'], $attr['iconMarginType']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTopMobile'], $attr['iconPaddingType']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRightMobile'], $attr['iconPaddingType']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottomMobile'], $attr['iconPaddingType']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeftMobile'], $attr['iconPaddingType']),
			),
			' .premium-icon-box:hover .premium-icon-box__icon ' => array(
				'margin-top'     => self::get_css_value($attr['iconMarginTopMobileH'], $attr['iconMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['iconMarginRightMobileH'], $attr['iconMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['iconMarginBottomMobileH'], $attr['iconMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['iconMarginLeftMobileH'], $attr['iconMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['iconPaddingTopMobileH'], $attr['iconPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['iconPaddingRightMobileH'], $attr['iconPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['iconPaddingBottomMobileH'], $attr['iconPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['iconPaddingLeftMobileH'], $attr['iconPaddingTypeH']),
			),

			'  .premium-icon-box__title' => array(
				'font-size'      => self::get_css_value($attr['titleSizeMobile'], $attr['titleSizeUnit']),
				'margin-top'     => self::get_css_value($attr['titleMarginTopMobile'], $attr['titleMarginType']),
				'margin-right'   => self::get_css_value($attr['titleMarginRightMobile'], $attr['titleMarginType']),
				'margin-bottom'  => self::get_css_value($attr['titleMarginBottomMobile'], $attr['titleMarginType']),
				'margin-left'    => self::get_css_value($attr['titleMarginLeftMobile'], $attr['titleMarginType']),
				'padding-top'    => self::get_css_value($attr['titlePaddingTopMobile'], $attr['titlePaddingType']),
				'padding-right'  => self::get_css_value($attr['titlePaddingRightMobile'], $attr['titlePaddingType']),
				'padding-bottom' => self::get_css_value($attr['titlePaddingBottomMobile'], $attr['titlePaddingType']),
				'padding-left'   => self::get_css_value($attr['titlePaddingLeftMobile'], $attr['titlePaddingType']),
			),
			' .premium-icon-box-label'   => array(
				'font-size'     => self::get_css_value($attr['labelSizeMobile'], $attr['labelSizeUnit']),
				'margin-top'    => self::get_css_value($attr['labelMarginTopMobile'], $attr['labelMarginType']),
				'margin-right'  => self::get_css_value($attr['labelMarginRightMobile'], $attr['labelMarginType']),
				'margin-bottom' => self::get_css_value($attr['labelMarginBottomMobile'], $attr['labelMarginType']),
				'margin-left'   => self::get_css_value($attr['labelMarginLeftMobile'], $attr['labelMarginType']),
			),
			' .premium-icon-box__desc'   => array(
				'font-size'      => self::get_css_value($attr['descSizeMobile'], $attr['descSizeUnit']),
				'margin-top'     => self::get_css_value($attr['descMarginTopMobile'], $attr['descMarginType']),
				'margin-right'   => self::get_css_value($attr['descMarginRightMobile'], $attr['descMarginType']),
				'margin-bottom'  => self::get_css_value($attr['descMarginBottomMobile'], $attr['descMarginType']),
				'margin-left'    => self::get_css_value($attr['descMarginLeftMobile'], $attr['descMarginType']),
				'padding-top'    => self::get_css_value($attr['descPaddingTopMobile'], $attr['descPaddingType']),
				'padding-right'  => self::get_css_value($attr['descPaddingRightMobile'], $attr['descPaddingType']),
				'padding-bottom' => self::get_css_value($attr['descPaddingBottomMobile'], $attr['descPaddingType']),
				'padding-left'   => self::get_css_value($attr['descPaddingLeftMobile'], $attr['descPaddingType']),
			),
			' .premium-icon-box__btn'    => array(
				'font-size'      => self::get_css_value($attr['btnSizeMobile'], $attr['btnSizeUnit']),
				'margin-top'     => self::get_css_value($attr['btnMarginTopMobile'], $attr['btnMarginType']),
				'margin-right'   => self::get_css_value($attr['btnMarginRightMobile'], $attr['btnMarginType']),
				'margin-bottom'  => self::get_css_value($attr['btnMarginBottomMobile'], $attr['btnMarginType']),
				'margin-left'    => self::get_css_value($attr['btnMarginLeftMobile'], $attr['btnMarginType']),
				'padding-top'    => self::get_css_value($attr['btnPaddingTopMobile'], $attr['btnPaddingType']),
				'padding-right'  => self::get_css_value($attr['btnPaddingRightMobile'], $attr['btnPaddingType']),
				'padding-bottom' => self::get_css_value($attr['btnPaddingBottomMobile'], $attr['btnPaddingType']),
				'padding-left'   => self::get_css_value($attr['btnPaddingLeftMobile'], $attr['btnPaddingType']),
			),
			' .premium-icon-box__btn_wrap:hover .premium-icon-box__btn' => array(
				'margin-top'     => self::get_css_value($attr['btnMarginTopMobileH'], $attr['btnMarginTypeH']),
				'margin-right'   => self::get_css_value($attr['btnMarginRightMobileH'], $attr['btnMarginTypeH']),
				'margin-bottom'  => self::get_css_value($attr['btnMarginBottomMobileH'], $attr['btnMarginTypeH']),
				'margin-left'    => self::get_css_value($attr['btnMarginLeftMobileH'], $attr['btnMarginTypeH']),
				'padding-top'    => self::get_css_value($attr['btnPaddingTopMobileH'], $attr['btnPaddingTypeH']),
				'padding-right'  => self::get_css_value($attr['btnPaddingRightMobileH'], $attr['btnPaddingTypeH']),
				'padding-bottom' => self::get_css_value($attr['btnPaddingBottomMobileH'], $attr['btnPaddingTypeH']),
				'padding-left'   => self::get_css_value($attr['btnPaddingLeftMobileH'], $attr['btnPaddingTypeH']),
			),
		);
		// Mobile CSS End.
