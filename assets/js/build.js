...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__icons__ = __webpack_require__(1);
...
if (__WEBPACK_IMPORTED_MODULE_0__settings__["i" /* iconBox */]) {
  ...
  registerBlockType("premium/icon-box", {
    title: __("Icon Box"),
    icon: wp.element.createElement(__WEBPACK_IMPORTED_MODULE_8__icons__["a" /* default */], { icon: "icon-box" }),
    category: "premium-blocks",
