window.onload = function() {
    var tabBlocks = document.querySelectorAll( '.wp-block-premium-tabs' );

    tabBlocks.forEach( function( tabBlock, i ){
        
        var tabLabels = tabBlock.querySelectorAll( '.premium-tab' );
        var tabPanels = tabBlock.querySelectorAll( '.wp-block-premium-tab-item' );
        ...
        var toggleAttributes = function (label, i){
                var activeTab = tabBlock.querySelector('.premium-tabs__active');
                var activePanel = tabBlock.querySelector('.wp-block-premium-tab-item');
