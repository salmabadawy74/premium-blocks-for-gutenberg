( function( blocks, components, i18n, element ) {
	...
	registerBlockType( 'premium/dheading-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
		title: i18n.__( 'Dual Heading' ), // The title of our block.
		description: i18n.__( 'A custom block for displaying dual heading.' ), // The description of our block.
		icon: 'editor-paragraph', // Dashicon icon for our block. Custom icons can be added using inline SVGs.
		category: 'premium-blocks', // The category of the block.
