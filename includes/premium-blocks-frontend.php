...
class Premium_Blocks_Frontend {
	...
	public function conditionally_render_block( $block_content, $block ) {
		if ( 'premium/fancy-text' === $block['blockName'] && isset( $block['attrs'] ) ) {
	 ...
	 */
	public function get_fancy_text_css_head( $attributes ) {
	...
	public function get_fancy_text_css( $attributes, $content ) {
		$attributes = apply_filters( 'kadence_get_fancy_text_css_block_attributes', $attributes );
		if ( ! wp_style_is( 'kadence-blocks-rowlayout', 'enqueued' ) ) {
			wp_enqueue_style( 'kadence-blocks-rowlayout' );
		}
		if ( isset( $attributes['uniqueID'] ) ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_accordion_css_head( $attributes ) {
			...
			if ( ! wp_style_is( $style_id, 'enqueued' ) && apply_filters( 'kadence_blocks_render_head_css', true, 'column', $attributes ) ) {
				...
				$css = $this->accordion_layout_css( $attributes, $unique_id );
				if ( ! empty( $css ) ) {
					$css = apply_filters( 'as3cf_filter_post_local_to_provider', $css );
					$this->render_inline_css( $css, $style_id );
				}
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_banner_css_head( $attributes ) {
		...
		if ( isset( $attributes['block_id'] ) ) {
			...
			if ( ! wp_style_is( $style_id, 'enqueued' ) && apply_filters( 'kadence_blocks_render_head_css', true, 'advancedbtn', $attributes ) ) {
				// Filter attributes for easier dynamic css.
				$attributes = apply_filters( 'kadence_blocks_banner_render_block_attributes', $attributes );
	 ...
	 * @param array  $attributes the blocks attribtues.
	 */
	public function get_button_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_countup_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_dual_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_testimonial_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_iconbox_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_videobox_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_pricing_css_head( $attributes ) {
	 ...
	 * @param array $attributes the blocks attribtues.
	 */
	public function get_lottie_css_head( $attributes ) {
	...
	public function register_scripts() {
		...
		wp_register_style( 'kadence-blocks-restaurant-menu', PREMIUM_BLOCKS_URL . 'dist/blocks/restaurant.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-rowlayout', PREMIUM_BLOCKS_URL . 'dist/blocks/row.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-accordion', PREMIUM_BLOCKS_URL . 'dist/blocks/accordion.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-btn', PREMIUM_BLOCKS_URL . 'dist/blocks/btn.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-gallery', PREMIUM_BLOCKS_URL . 'dist/blocks/gallery.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		//wp_register_style( 'kadence-blocks-icon', PREMIUM_BLOCKS_URL . 'dist/blocks/icon.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-icon', false );
		wp_register_style( 'kadence-blocks-iconlist', PREMIUM_BLOCKS_URL . 'dist/blocks/iconlist.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-tabs', PREMIUM_BLOCKS_URL . 'dist/blocks/tabs.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-spacer', PREMIUM_BLOCKS_URL . 'dist/blocks/spacer.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-infobox', PREMIUM_BLOCKS_URL . 'dist/blocks/infobox.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		//wp_register_style( 'kadence-blocks-heading', PREMIUM_BLOCKS_URL . 'dist/blocks/heading.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-heading', false );
		wp_register_style( 'kadence-blocks-form', PREMIUM_BLOCKS_URL . 'dist/blocks/form.style.build.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_style( 'kadence-blocks-testimonials', PREMIUM_BLOCKS_URL . 'dist/blocks/testimonials.style.build.css', array(), PREMIUM_BLOCKS_VERSION );

		//wp_enqueue_style( 'kadence-blocks-style-css', PREMIUM_BLOCKS_URL . 'dist/blocks.style.build.css', array(), PREMIUM_BLOCKS_VERSION );

		// Next all the extras that are shared.
		wp_register_style( 'kadence-simplelightbox-css', PREMIUM_BLOCKS_URL . 'dist/assets/css/simplelightbox.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_script( 'kadence-simplelightbox', PREMIUM_BLOCKS_URL . 'dist/assets/js/simplelightbox.min.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-videolight-js', PREMIUM_BLOCKS_URL . 'dist/assets/js/kb-init-video-popup.min.js', array( 'kadence-simplelightbox' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_style( 'kadence-blocks-magnific-css', PREMIUM_BLOCKS_URL . 'dist/magnific.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_script( 'magnific-popup', PREMIUM_BLOCKS_URL . 'dist/magnific.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-magnific-js', PREMIUM_BLOCKS_URL . 'dist/kt-init-video-popup.js', array( 'jquery', 'magnific-popup' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-gallery-magnific-init', PREMIUM_BLOCKS_URL . 'dist/kb-gallery-magnific-init.js', array( 'jquery', 'magnific-popup' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-simplelightbox-init', PREMIUM_BLOCKS_URL . 'dist/kb-gallery-simple-init.js', array( 'kadence-simplelightbox' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-accordion-js', PREMIUM_BLOCKS_URL . 'dist/kt-accordion-min.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-tabs-js', PREMIUM_BLOCKS_URL . 'dist/kt-tabs-min.js', array( 'jquery' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'jarallax', PREMIUM_BLOCKS_URL . 'dist/jarallax.min.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-form', PREMIUM_BLOCKS_URL . 'dist/assets/js/kb-form-block.min.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_localize_script(
			'kadence-blocks-form',
		...
		wp_register_script( 'kadence-blocks-google-recaptcha-v3', 'https://www.google.com/recaptcha/api.js?render=' . esc_attr( $recaptcha_site_key ), array(), PREMIUM_BLOCKS_VERSION, true );
		...
		wp_register_script( 'kadence-blocks-google-recaptcha-v2', 'https://www.google.com/recaptcha/api.js?render=explicit&onload=kbOnloadV2Callback', array( 'jquery' ), PREMIUM_BLOCKS_VERSION, true );
		//wp_register_script( 'kadence-blocks-recaptcha-v2-form', PREMIUM_BLOCKS_URL . 'dist/assets/js/kb-form-recaptcha-v2.js', array( 'jquery', 'kadence-blocks-google-recaptcha-v2' ), PREMIUM_BLOCKS_VERSION, true );
		// wp_localize_script(
		...
		wp_register_script( 'kadence-blocks-parallax-js', PREMIUM_BLOCKS_URL . 'dist/kt-init-parallax.js', array( 'jarallax' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_style( 'kadence-blocks-pro-slick', PREMIUM_BLOCKS_URL . 'dist/vendor/kt-blocks-slick.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_script( 'kadence-slick', PREMIUM_BLOCKS_URL . 'dist/vendor/slick.min.js', array( 'jquery' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-slick-init', PREMIUM_BLOCKS_URL . 'dist/kt-slick-init.js', array( 'jquery', 'kadence-slick' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_style( 'kadence-blocks-tiny-slider', PREMIUM_BLOCKS_URL . 'dist/assets/css/tiny-slider.css', array(), PREMIUM_BLOCKS_VERSION );
		wp_register_script( 'kadence-blocks-tiny-slider', PREMIUM_BLOCKS_URL . 'dist/assets/js/tiny-slider.min.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-tiny-slider-init', PREMIUM_BLOCKS_URL . 'dist/assets/js/kb-tiny-init.min.js', array( 'kadence-blocks-tiny-slider' ), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-video-bg', PREMIUM_BLOCKS_URL . 'dist/kb-init-html-bg-video.js', array(), PREMIUM_BLOCKS_VERSION, true );
		wp_register_script( 'kadence-blocks-masonry-init', PREMIUM_BLOCKS_URL . 'dist/kb-masonry-init.js', array( 'masonry' ), PREMIUM_BLOCKS_VERSION, true );
	}
	/**
		...
		if ( ! method_exists( $post_object, 'post_content' ) ) {
			...
			foreach ( $blocks as $indexkey => $block ) {
				...
				if ( ! is_object( $block ) && is_array( $block ) && isset( $block['blockName'] ) ) {
					...
					if ( 'premium/fancy-text' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_fancy_text_css_head( $blockattr );
							$this->render_row_layout_scripts( $blockattr );
						}
					}
					if ( 'premium/accordion' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
                                                  

							$blockattr = $block['attrs'];
							$this->get_accordion_css_head( $blockattr );
						}
					}
					if ( 'kadence/advancedheading' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_button_css_head( $blockattr );
						}
					}
					if ( 'premium/banner' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_banner_css_head( $blockattr );
						}
					}
					if ( 'kadence/accordion' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_videobox_css_head( $blockattr );
					...
					if ( 'kadence/tabs' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_countup_css_head( $blockattr );
					...
					if ( 'kadence/infobox' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_iconbox_css_head( $blockattr );
						}
					}
					...
					if ( 'kadence/icon' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_testimonial_css_head( $blockattr );
						}
					}
					if ( 'kadence/testimonials' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_pricing_css_head( $blockattr );
					...
					if ( 'kadence/advancedgallery' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_lottie_css_head( $blockattr );
					...
					if ( 'kadence/spacer' === $block['blockName'] ) {
						if ( isset( $block['attrs'] ) && is_array( $block['attrs'] ) ) {
							$blockattr = $block['attrs'];
							$this->get_dual_css_head( $blockattr );
						}
					}
	...
	public function blocks_cycle_through( $inner_blocks ) {
		foreach ( $inner_blocks as $in_indexkey => $inner_block ) {
			...
			if ( ! is_object( $inner_block ) && is_array( $inner_block ) && isset( $inner_block['blockName'] ) ) {
				if ( 'premium/fancy-text' === $inner_block['blockName'] ) {
				...
				if ( 'premium/banner' === $inner_block['blockName'] ) {
					if ( isset( $inner_block['attrs'] ) && is_array( $inner_block['attrs'] ) ) {
						$blockattr = $inner_block['attrs'];
						$this->get_banner_css_head( $blockattr );
					}
	 ...
	 */
	public function accordion_layout_css( $attr, $unique_id ) {
		$css                    = new Premium_Blocks_css();
		$media_query            = array();
		$media_query['mobile']  = apply_filters( 'kadence_mobile_media_query', '(max-width: 767px)' );
		$media_query['tablet']  = apply_filters( 'kadence_tablet_media_query', '(max-width: 1024px)' );
