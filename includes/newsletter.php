...
?>
			<div id="<?php echo esc_html($id); ?>" class="premium-newsletter__wrapper ">
				<div class="<?php echo esc_html(implode(' ', $column)); ?>">
					...
					<?php endif; ?>
					<input class="premium-newsletter-input" type="email" value="<?php echo esc_html($attributes['eMail']); ?>" name="form_fields[email]" id="pa_news_email" class="" placeholder="Email" aria-required="true" />
				</div>
...
<?php
		...
		public function subscribe_newsletter($attributes)
		{
			...
			$apikey  = '8d65efde1b8746391279891320c74f6b-us20';
			$list_id = '8286186162';
			$status  = false;
